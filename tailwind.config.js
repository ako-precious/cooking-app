...
export default {
  ...
  theme: {
    ...
    boxShadow: {
      ...
      none: "none",
      "-oynx-sm": '-1px -1px 4px #131614, 1px 1px 4px #3b413e',
      "oynx-inner": 'inset 4px 4px 8px #161917, inset -4px -4px 8px #4a534f',
      "oynx-sm": '1px 1px 4px #131614, -1px -1px 4px #3b413e',
      "snow-inner": 'inset 4px 4px 8px #848484, inset -4px -4px 8px #ffffff',
      "-snow-sm": '-1px -1px 4px #656363, 1px 1px 4px #ffffff',
      "snow-sm": '1px 1px 4px #656363, -1px -1px 4px #ffffff',
      "oynx-md": ' 1px 1px 4px #222624, -1px -1px 4px #3e4642',
      "-oynx-md": '-1px -1px 4px #161917, 1px 1px 4px #4a534f',
      "snow-md": '1px 1px 4px #6c6c6c, -1px -1px 4px #ffffff',
      "-snow-md": '-1px -1px 4px #6c6c6c, 1px 1px 4px #ffffff',
      "oynx-lg": '1px 1px 4px #1f2321, -1px -1px 4px #414945',
      "-oynx-lg": '-1px -1px 4px #1f2321, 1px 1px 4px #414945',
      "snow-lg": '1px 1px 4px #a19e9f, -1px -1px 4px #ffffff',
      "-snow-lg": '-1px -1px 4px #a19e9f, 1px 1px 4px #ffffff',
    },
