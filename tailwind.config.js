...
export default {
  ...
  theme: {
    ...
    boxShadow: {
      ...
      "oynx-inner": 'inset 8px 8px 13px #161917, inset -8px -8px 13px #4a534f',
      "oynx-sm": '7px 7px 10px #131614, -7px -7px 10px #3b413e',
      "snow-inner": 'inset 8px 8px 13px #848484, inset -8px -8px 13px #ffffff',
      "-snow-sm": '-7px -7px 10px #656363, 7px 7px 10px #ffffff',
      "snow-sm": '7px 7px 10px #656363, -7px -7px 10px #ffffff',
      "oynx-md": ' 14px 14px 18px #222624, -14px -14px 18px #3e4642',
      "-oynx-md": '-15px -15px 15px #161917, 15px 15px 15px #4a534f',
      "snow-md": '15px 15px 15px #6c6c6c, -15px -15px 15px #ffffff',
      "-snow-md": '-15px -15px 15px #6c6c6c, 15px 15px 15px #ffffff',
      "oynx-lg": '25px 25px 50px #1f2321, -25px -25px 50px #414945',
      "-oynx-lg": '-25px -25px 50px #1f2321, 25px 25px 50px #414945',
      "snow-lg": '25px 25px 50px #a19e9f, -25px -25px 50px #ffffff',
      "-snow-lg": '-25px -25px 50px #a19e9f, 25px 25px 50px #ffffff',
    },
