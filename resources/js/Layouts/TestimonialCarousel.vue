...
const prev = () => {
  testimonialActive.value =
    testimonialActive.value === 1 ? testimonials.length : testimonialActive.value - 1;
};

const next = () => {
  testimonialActive.value =
    testimonialActive.value >= testimonials.length ? 1 : testimonialActive.value + 1;
};
</script>
...
<template>
  <div class="my-10 md:my-24 container mx-auto flex flex-col md:flex-row shadow-sm overflow-hidden">
    <!-- Left Side -->
    <div class="relative w-full py-2 md:py-24 bg-indigo-700 md:w-1/2 flex flex-col justify-center">
