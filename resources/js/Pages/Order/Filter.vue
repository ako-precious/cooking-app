<template>
    <form @submit.prevent="filter">
        <div class="mb-8 mt-4 flex flex-col gap-2 justify-center overflow-x-scroll disable-scrollbars">
            ...
            <div class="flex flex-nowrap items-center">
                <div class="flex items-center border-2 py-1 px-1.5 rounded-lg  mr-1">
                    <select v-model="filterForm.status"
                        class="outline-none border-none bg-transparent text-white text-sm capitalize"
                    >
                       <option class="bg-snow dark:bg-oynx  p-2 " :value="null">Status</option>
                       <option class="bg-snow dark:bg-oynx  p-2 " value="pending">Pending</option>
                       <option class="bg-snow dark:bg-oynx  p-2 " value="rejected">Rejected</option>
                       <option class="bg-snow dark:bg-oynx  p-2 " value="accepted">Accepted</option>
                       <option class="bg-snow dark:bg-oynx  p-2 " value="processed">Processed</option>
                       <option class="bg-snow dark:bg-oynx  p-2 " value="ready">Ready</option>
                       <option class="bg-snow dark:bg-oynx  p-2 " value="in transit">In Transit</option>
                       <option class="bg-snow dark:bg-oynx  p-2 " value="delivered">Delivered</option>
                       <option class="bg-snow dark:bg-oynx  p-2 " value="confirmed">Confirmed</option>
                    </select>
                </div>
                <div class="flex items-center border-2 py-1 px-1.5 rounded-lg ">
                    ...
                    >
                        <option class="bg-snow dark:bg-oynx  p-2 " :value="null">Meal Time</option>
                        <option class="bg-snow dark:bg-oynx  p-2 " value="breakfast">Breakfast</option>
                        <option class="bg-snow dark:bg-oynx  p-2 " value="lunch">Lunch</option>
                        <option class="bg-snow dark:bg-oynx  p-2 " value="dinner">Dinner</option>
                    </select>
                </div>
            </div>
            <div class="flex flex-nowrap items-center">
