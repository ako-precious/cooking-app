<template>
    <div
        class="relative m-auto flex w-full max-w-xs flex-col overflow-hidden rounded-xl dark:foodcard shadow-md"
    >
        ...
        <div class="mt-4 px-5 pb-5">
            <a href="#">
                <h5 class="text-lg tracking-tight text-oynx dark:text-snow">
