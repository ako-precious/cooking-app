...
<template>
    ...
    <div
        class="bg-persian fixed w-screen h-screen overflow-y-auto overflow-x-hidden"
    >
        ...
        >
            ...
            <img
                src="/images/blob.svg"
                data-speed="5"
                class="parallax layer absolute w-[40rem] -bottom-16 -left-16"
            />
            <img
                src="/images/blob-haik.svg"
                data-speed="9"
                class="parallax layer absolute w-[40rem] -top-16 -right-[7rem]"
            />
            <img
                src="/images/blob-hai.svg"
                data-speed="15"
            ...
            <img
                src="/images/blob-hakei.svg"
                data-speed="-9"
                class="parallax layer absolute w-[40rem] -bottom-1/3"
            />
            <img
                src="/images/blob-hakei.svg"
                data-speed="-15"
...
class="parallax layer absolute w-[35rem] -bottom-10 -left-10 -z-"
>
