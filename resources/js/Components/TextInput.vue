...
<template>
    <input
        ref="input"
        class="input dark:input   focus:border-polynesian dark:focus:border-lighred focus:ring-polynesian dark:focus:ring-lighred rounded-md  text-oynx dark:text-snow"
        :value="modelValue"
