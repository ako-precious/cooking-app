<template>
    <div>
      <div class="antialiased sans-serif bg-gray-100 h-screen">
        <div v-bind:x-data="app()" v-init="[initDate(), getNoOfDays()]" x-cloak>
                    ...
                    <div style="width: 14.28%; height: 120px" class="px-4 pt-2 border-r border-b relative">
                      ...
                      <div style="height: 80px;" class="overflow-y-auto mt-1">
                        <template v-for="event in events.filter(e => new Date(e.event_date).toDateString() ===  new Date(year, month, date).toDateString() )">
                          ...
                          >
                            <p v-text="event.event_title" class="text-sm truncate leading-tight"></p>
                          </div>
                        </template>
                      </div>
                    </div>
  ...
  export default {
    ...
    methods: {
      ...
      showEventModal(date) {
        // ... your showEventModal logic
      },
      addEvent() {
        // ... your addEvent logic
      },
      getNoOfDays() {
        // ... your getNoOfDays logic
      },
    },
    mounted() {
      this.initDate();
